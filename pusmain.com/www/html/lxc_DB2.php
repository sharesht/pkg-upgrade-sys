<html>
	...
	<?php
		...
		if (mysqli_num_rows($result) > 0) {
			...
			while($row = mysqli_fetch_assoc($result)) {
				...
				echo "<form action='lxc_DB2.php' method='post' name='selected' id ='selected'>";
	...
	?>
		...
		<form action='lxc_DB2.php' method='post' name='all' id='all'>
		...
		<form action='lxc_DB2listservice.php' method='post' name='all' id='all'>
